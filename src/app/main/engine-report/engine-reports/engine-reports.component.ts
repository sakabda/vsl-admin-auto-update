...
@Component({
  selector: 'app-engine-reports',
  templateUrl: './engine-reports.component.html',
  styleUrls: ['./engine-reports.component.scss'],
})
export class EngineReportsComponent implements OnInit {
  allReports: any[] = [];
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
