...
@Component({
  selector: 'app-add-update-daily-report-at-port',
  templateUrl: './add-update-daily-report-at-port.component.html',
  styleUrls: ['./add-update-daily-report-at-port.component.scss'],
})
export class AddUpdateDailyReportAtPortComponent implements OnInit {
  ...
  constructor(
    ...
    this.addUpdateDailyReportReportForm = this.fb.group({
      ...
      DailyRept_VslActivity_At_Port_StartDate: [null, [Validators.required]],
      DailyRept_VslActivity_At_Port_StartTime: [null, [Validators.required]],
      DailyRept_VslActivity_At_Port_EndDate: [null, [Validators.required]],
      DailyRept_VslActivity_At_Port_EndTime: [null, [Validators.required]],

      // At port (Main. Engine - Consumption)
      DailyRept_AtPort_MECons_ME1RHRS: [null],
      DailyRept_AtPort_MECons_LOCons1: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_MECons_ME2RHRS: [null],
      DailyRept_AtPort_MECons_LOCons2: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_MECons_ME3RHRS: [null],
      DailyRept_AtPort_MECons_LOCons3: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_MECons_ME4RHRS: [null],
      DailyRept_AtPort_MECons_LOCons4: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_MECons_TotalMEFuelCons: [null],
      DailyRept_AtPort_MECons_FuelInUse: [null],
      DailyRept_AtPort_MECons_AddComments: [null],

      // At Port (Aux. Engine - Consumption)
      DailyRept_AtPort_AECons_AE1RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_AtPort_AECons_AE1RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_AtPort_AECons_LOCons1: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_AECons_AE2RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_AtPort_AECons_AE2RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_AtPort_AECons_LOCons2: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_AECons_AE3RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_AtPort_AECons_AE3RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_AtPort_AECons_LOCons3: [null, this.rangeValidator(0, 9999)],
      DailyRept_AtPort_AECons_AE4RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_AtPort_AECons_AE4RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_AtPort_AECons_LOCons4: [null, this.rangeValidator(0, 9999)],
  ...
  getDailyReportByIdLocal(): void {
    this.localDatabaseService
      ...
      .then((data) => {
        ...
        if (data.DailyRept_AtPort_AECons_FuelInUse) {
          this.addUpdateDailyReportReportForm.patchValue({
            DailyRept_AtPort_AECons_FuelInUse:
              data.DailyRept_AtPort_AECons_FuelInUse,
          });
        }
        if (data.DailyRept_AtPort_MECons_FuelInUse) {
          this.addUpdateDailyReportReportForm.patchValue({
            DailyRept_AtPort_MECons_FuelInUse:
              data.DailyRept_AtPort_MECons_FuelInUse,
          });
        }

        if (data.DailyRept_AtPort_BLRCons_FuelInUse) {
          this.addUpdateDailyReportReportForm.patchValue({
            DailyRept_AtPort_BLRCons_FuelInUse:
              data.DailyRept_AtPort_BLRCons_FuelInUse,
          });
        }
      })
      .catch((err) => {
  ...
  getDailyReportById(): void {
    this.httpRequestService
      .request('get', `daily-report-at-ports/${this.idForUpdate}`)
      .subscribe(
        (result) => {
          ...
          if (result.data.DailyRept_AtPort_MECons_FuelInUse) {
            this.addUpdateDailyReportReportForm.patchValue({
              DailyRept_AtPort_MECons_FuelInUse:
                result.data.DailyRept_AtPort_MECons_FuelInUse._id,
            });
          }
  ...
  submit(): void {
    if (!this.addUpdateDailyReportReportForm.valid) {
      ...
      if (this.idForUpdate) {
        ...
        //   'put',
        //   `daily-report-at-ports/${this.idForUpdate}`,
        ...
        if (this.localUser?.Role === 'reader') {
          ...
          console.log('at port form vbalue submit', this.addUpdateDailyReportReportForm.value);
          this.reportingStore
