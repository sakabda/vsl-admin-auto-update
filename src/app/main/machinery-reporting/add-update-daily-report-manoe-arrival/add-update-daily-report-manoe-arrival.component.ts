...
@Component({
  selector: 'app-add-update-daily-report-manoe-arrival',
  templateUrl: './add-update-daily-report-manoe-arrival.component.html',
  styleUrls: ['./add-update-daily-report-manoe-arrival.component.scss'],
})
export class AddUpdateDailyReportManoeArrivalComponent implements OnInit {
  ...
  constructor(
    ...
    this.addUpdateDailyReportReportForm = this.fb.group({
      ...
      DailyRept_ManoeuvringArrival_MEInfo_MERhrs:[null,[Validators.required,Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_ManoeuvringArrival_MEInfo_MERhrs_TotalCounter:[null,[Validators.required,Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],
      ...
      DailyRept_ManoeuvringArrival_AECons_AE1RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_ManoeuvringArrival_AECons_AE1RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_ManoeuvringArrival_AECons_LOCons1: [
        null,
        this.rangeValidator(0, 9999),
      ],
      DailyRept_ManoeuvringArrival_AECons_AE2RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_ManoeuvringArrival_AECons_AE2RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_ManoeuvringArrival_AECons_LOCons2: [
        null,
        this.rangeValidator(0, 9999),
      ],
      DailyRept_ManoeuvringArrival_AECons_AE3RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_ManoeuvringArrival_AECons_AE3RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],

      DailyRept_ManoeuvringArrival_AECons_LOCons3: [
        null,
        this.rangeValidator(0, 9999),
      ],
      DailyRept_ManoeuvringArrival_AECons_AE4RHRS:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,26)]],
      DailyRept_ManoeuvringArrival_AECons_AE4RHRS_TotalCounter:[null,[Validators.pattern('^[.0-9]*$'),this.rangeValidator(0,200000)]],
