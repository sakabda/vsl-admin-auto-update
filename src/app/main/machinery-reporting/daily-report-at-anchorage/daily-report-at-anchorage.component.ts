...
@Component({
  selector: 'app-daily-report-at-anchorage',
  templateUrl: './daily-report-at-anchorage.component.html',
  styleUrls: ['./daily-report-at-anchorage.component.scss'],
})
export class DailyReportAtAnchorageComponent implements OnInit {
  allReports: any;
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
  ...
  getAllReports(skip = 0, sortBy?: any): void {
    ...
    this.httpRequestService
      .request('get', 'daily-report-at-anchorages', params)
      .subscribe(
        (result) => {
          console.log(result);
          this.loading = false;
  ...
  delete(id: string): void {
    this.httpRequestService
      .request('delete', `daily-report-at-anchorages/${id}`)
