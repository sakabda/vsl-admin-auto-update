...
@Component({
  selector: 'app-daily-report-at-sea',
  templateUrl: './daily-report-at-sea.component.html',
  styleUrls: ['./daily-report-at-sea.component.scss'],
})
export class DailyReportAtSeaComponent implements OnInit {
  allReports: any;
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
  ...
  getAllReports(skip = 0, sortBy?: any): void {
    ...
    this.httpRequestService
      .request('get', 'daily-report-at-seas', params)
      .subscribe(
        (result) => {
          console.log(result);
          this.loading = false;
  ...
  delete(id: string): void {
    this.httpRequestService
      .request('delete', `daily-report-at-seas/${id}`)
