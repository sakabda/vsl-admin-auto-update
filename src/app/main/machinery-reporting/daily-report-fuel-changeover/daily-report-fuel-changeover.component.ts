...
@Component({
  selector: 'app-daily-report-fuel-changeover',
  templateUrl: './daily-report-fuel-changeover.component.html',
  styleUrls: ['./daily-report-fuel-changeover.component.scss'],
})
export class DailyReportFuelChangeoverComponent implements OnInit {
  allReports: any;
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
  ...
  getAllReports(skip = 0, sortBy?: any): void {
    ...
    this.httpRequestService
      .request('get', 'daily-report-fuel-changeovers', params)
      .subscribe(
        (result) => {
          console.log(result);
          this.loading = false;
  ...
  delete(id: string): void {
    this.httpRequestService
      .request('delete', `daily-report-fuel-changeovers/${id}`)
