...
@Component({
  selector: 'app-daily-report-manoe-arrival',
  templateUrl: './daily-report-manoe-arrival.component.html',
  styleUrls: ['./daily-report-manoe-arrival.component.scss'],
})
export class DailyReportManoeArrivalComponent implements OnInit {
  allReports: any;
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
  ...
  getAllReports(skip = 0, sortBy?: any): void {
    ...
    this.httpRequestService
      .request('get', 'daily-report-manoeuvring-arrivals', params)
      .subscribe(
        (result) => {
          console.log(result);
          this.loading = false;
  ...
  delete(id: string): void {
    this.httpRequestService
      .request('delete', `daily-report-manoeuvring-arrivals/${id}`)
