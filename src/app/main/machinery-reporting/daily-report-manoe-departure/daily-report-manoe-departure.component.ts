...
@Component({
  selector: 'app-daily-report-manoe-departure',
  templateUrl: './daily-report-manoe-departure.component.html',
  styleUrls: ['./daily-report-manoe-departure.component.scss'],
})
export class DailyReportManoeDepartureComponent implements OnInit {
  allReports: any;
  totalDataCount = 0;
  pageSize = 10;
  pageIndex = 1;
  ...
  getAllReports(skip = 0, sortBy?: any): void {
    ...
    this.httpRequestService
      .request('get', 'daily-report-manoeuvring-departures', params)
      .subscribe(
        (result) => {
          console.log(result);
          this.loading = false;
  ...
  delete(id: string): void {
    this.httpRequestService
      .request('delete', `daily-report-manoeuvring-departures/${id}`)
